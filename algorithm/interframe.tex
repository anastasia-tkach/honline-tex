...
\end{aligned}
\end{equation*}
\caption{Inter-frame Kalman regression \AT{what's the point of the big arrays? They tell me nothing as a reader?} \AT{Apply change into ${\Sigma} \Rightarrow \star{\Sigma}$ if approved}}
