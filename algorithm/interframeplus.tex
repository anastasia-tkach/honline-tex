...
\end{aligned}
\end{equation*}
\caption{\TODO{Objective function of IEKF} \todo{note: I've condensed the evaluation of the derivative at the point: $\tfrac{\partial f(x)}{\partial x|_{x_0}}$ as $\tfrac{\partial f(x_0)}{\partial x}$}}
