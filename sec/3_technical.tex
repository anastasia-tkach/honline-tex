...
The covariance matrix~$\star\Sigma_n$ of the Laplace approximation (see \Appendix{laplace-approximation}) is the inverse of the Hessian of~$E$, and as we are using a Gauss-Newton solver, $E(x)$ is of the form $\|d_n - F(x_n)\|^2$, so we may make the G-N approximation of the Hessian in terms of the Jacobian of~
%$F$
