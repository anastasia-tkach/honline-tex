...
\subsection{Intra-frame distribution $p(x_n|d_n)$}
...
\begin{edit}
To the best of our knowledge, this simple relationship between LM and IEKF in \Equation{iekflm} was unknown. In a practical setting, this observation creates a very simple way to encode IEKF-like behavior within existing LM optimization codebases.  \AF{A bit rich for me to say this, as it's mentioned at in p35 of ``Bundle Adjustment: A modern synthesis'', and I've said it a few times at summer schools etc since http://www.bmva.org/meetings.d/04/17nov/prog.pdf ...}
\end{edit}
