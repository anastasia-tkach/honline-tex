...
\MP{I suggest that still provide a complete list of the energy functions, either in an appendix or a supplemental material. This way, the paper will be (a bit) more self-contained.}
\AT{What's the difference? It'd be in a separate PDF anyway?}
