...
%% personal comments
%% 
\newcommand{\AN}[1]{{\color{JungleGreen}[Anastasia: #1]}} % anastasia 
% (don't want to be sexist, but if you don't like pink, change it!)
\newcommand{\AT}[1]{{\color{pink}[Andrea: #1]}} % andrea
% (andrea, if you do not mind pink - here you go)
