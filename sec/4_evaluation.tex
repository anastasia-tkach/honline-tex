...
In \Figure{synthetic}, we visualize our two metrics as we vary the intensity of the perturbation. Our perturbation analysis is performed over \TODO{2h30s} of synthetic footage, thus in our \VideoSynth{}, we only report a \emph{random selection} of tracked synthetic sequences.
% 
...
\TODO{anastasia, I need to know which joints were used? no palm, only fingers, etc...}
