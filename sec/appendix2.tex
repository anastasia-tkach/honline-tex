...
Link to \Section{inter}. Let us consider the special case when the measurement $z_n = x_n^*$ is in the same space at the estimated state $\hat{x}_n$, thus when $J$ is the identity matrix.
% 
\begin{align*}
\hat{x}_n 
...
\label{app:ieif-lm}
\TODO{Equivalence of IEIF and \Table{iekf-like}}
% 
