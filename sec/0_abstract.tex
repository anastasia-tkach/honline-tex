...
% kalman -> optimality
Our approach integrates in continous generative motion tracking software, and, under certain assumptions, can be considered optimal, as we derive its relationship to the theory of probabilistic Kalman filters.
