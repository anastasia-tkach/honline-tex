...
{\color{inter} inter-frame estimate $\hat{\beta}_n$}, 
diagonal entry of the covariance matrices for 
{\color{varintra} intra-frame $\star\Sigma_n$} and 
{\color{varinter} inter-frame $\hat\Sigma_n$} estimates.
% 
(bottom) We also display the pose corresponding to a selection of frames in the sequence~(small grey arrows).
% 
}
\label{fig:interreal}
\end{figure*}
