...
\put(1,86){\small $\%$}
% ALGORITHMS LEGEND
\put(\off,41){\scriptsize \color[RGB]{217,144,143}      Kalman Standard -- \Table{kf-like}???}
\put(\off,38){\scriptsize \color[RGB]{178,68,117}       Kalman Extended -- \Table{iekf-like}???}
\put(\off,35){\scriptsize \color[RGB]{179,179,179}      Batch-Offline -- \todo{????}}
\put(\off,32){\scriptsize \color[RGB]{160,215,190}      Batch-Online -- \todo{????}}
\put(\off,29){\scriptsize \color[RGB]{61,131,119}       Online --  \todo{????}}
