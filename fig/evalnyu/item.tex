...
\put(\off,37){\scriptsize \color[RGB]{61,131,119}    Intra -- \Eq{energies}}
\put(\off,34){\scriptsize \color[RGB]{217,144,143}   Split inter (KF) -- \Tab{kf-like}}
\put(\off,31){\scriptsize \color[RGB]{178,68,117}    Joint inter (IEKF) -- \Tab{iekf-like}}
