...
\put(\off,40){\scriptsize \color[RGB]{197,151,53}    Batch-Offline -- \Sec{todo}}
\put(\off,37){\scriptsize \color[RGB]{160,215,190}   Batch-Online -- \Sec{todo}}
\put(\off,34){\scriptsize \color[RGB]{61,131,119}    Intra-frame -- \Eq{energies}}
\put(\off,31){\scriptsize \color[RGB]{217,144,143}   Inter-frame (KF) -- \Tab{kf-like}}
\put(\off,28){\scriptsize \color[RGB]{178,68,117}    Inter-frame (EKF) -- \Tab{iekf-like}}
