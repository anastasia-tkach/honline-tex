...
\AN{Maybe add the following: Even though the parameter $\beta_{[2]}$ was not observed directly in any of the presented frames, its value was inferred from hight certainty measurements of  $\beta_{[1]}$ at $n = 2$ and  $\beta_{[1]} + \beta_{[2]}$ at $n = 3.$}
