...
We analyze the landscape of the registration energy {\color{anagreen}$E(\shape_{[1]})$}, d observe how estimation uncertainty relates to the width of the local minima valley. This uncertainty can be estimated through a quadratic approximation {\color{anasalmon}$\tilde{E}(\shape_{[1]})$}, derived from the Jacobians of the registration energies.
% 
%
}
\label{fig:intra}
