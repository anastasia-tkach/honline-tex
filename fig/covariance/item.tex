...
% 
Note how a confident guess \AN{could you please replace guess by measurement or estimate?}for the $\star\beta$ parameters is only available when $\theta_{[1]}$ and $\theta_{[2]}$ are simultaneously large, that is, with both phalanxes bent.
% 
