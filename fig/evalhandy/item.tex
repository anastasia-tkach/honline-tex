...
\put(\off,36){\scriptsize \color[RGB]{61,131,119}      Intra -- \Eq{energies}}
\put(\off,33){\scriptsize \color[RGB]{219,158,148}     Split inter (KF) -- \Tab{kf-like}}
\put(\off,30){\scriptsize \color[RGB]{182,78,124}      Joint inter (IEKF) -- \Tab{iekf-like}}
